...
const returnBook = async (req, res) => {
  try {
    ...
    // API for Find the book by its name
    const book = await Book.findOne({
      name: { $regex: bookName, $options: "i" },
    });
    if (!book) {
...
// API for  Total rent generated by book
...
// API - Gets books issued to person
...
// API for getting book issued in Date Range
